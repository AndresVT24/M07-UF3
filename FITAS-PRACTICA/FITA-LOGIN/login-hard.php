...
<body>
    ...
    <div>
        ...
        <form action="" method="POST">
            ...
            <p>PASSWORD AGAIN</p>
            <input type="password" name="passwordRegister2"><br>
            <input type="submit" name="" id="">
        </form>
    </div>
    <?php

    if(isset($_POST["nameRegister"]) && isset($_POST["passwordRegister"]) && isset($_POST["passwordRegister2"])){
        if($_POST["passwordRegister2"] != $_POST["passwordRegister"]){
